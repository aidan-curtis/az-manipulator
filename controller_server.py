...
def dual_drake_ik(message):
    ...
    xyz_right = message['xyz_right']
    quat_right = message['quat_right']
    xyz_left = message['xyz_left'] 
    quat_left = message['quat_left']
    q0_old_ordering = message['q0_old_ordering']
    ARM_ONLY = message['ARM_ONLY']
