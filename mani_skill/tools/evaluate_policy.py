...
def parse_args():
    ...
    parser.add_argument('--level-range', type=str, default='0-250')  # format is like $START_LEVEL-$END_LEVEL
...
args = parse_args()
# args.env = 'OpenCabinetDoor-v0'
# args.env = 'OpenCabinetDrawer-v0'
# args.env = 'MoveBucket-v0'
# args.env = 'PushChair-v0'
